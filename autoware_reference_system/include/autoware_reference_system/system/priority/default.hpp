...
namespace priority
{
  struct Default
  {
    static constexpr int FRONT_LIDAR_DRIVER_CALLBACK = 38;
    static constexpr int REAR_LIDAR_DRIVER_CALLBACK = 37;
    static constexpr int POINT_CLOUD_MAP_CALLBACK = 31;
    static constexpr int LANELET_2_MAP_CALLBACK = 22;
    static constexpr int VISUALIZER_CALLBACK = 19;
    static constexpr int POINTS_TRANSFORMER_REAR_CALLBACK = 39;
    static constexpr int POINTS_TRANSFORMER_FRONT_CALLBACK = 40;
    static constexpr int POINT_CLOUD_FUSION_CALLBACK_1 = 42;
    static constexpr int POINT_CLOUD_FUSION_CALLBACK_2 = 41;
    static constexpr int POINT_CLOUD_MAP_LOADER_CALLBACK = 32;
    static constexpr int VOXEL_GRID_DOWNSAMPLER_CALLBACK = 33;
    static constexpr int RAY_GROUND_FILTER_CALLBACK = 43;
    static constexpr int NDT_LOCALIZER_CALLBACK_1 = 35;
    static constexpr int NDT_LOCALIZER_CALLBACK_2 = 34;
    static constexpr int EUCLIDEAN_CLUSTER_DETECTOR_CALLBACK = 44;
    static constexpr int LANELET_2_GLOBAL_PLANNER_CALLBACK_1 = 20;
    static constexpr int LANELET_2_GLOBAL_PLANNER_CALLBACK_2 = 21;
    static constexpr int LANELET_2_MAP_LOADER_CALLBACK_1 = 24;
    static constexpr int LANELET_2_MAP_LOADER_CALLBACK_2 = 23;
    static constexpr int PARKING_PLANNER_CALLBACK = 25;
    static constexpr int LANE_PLANNER_CALLBACK = 26;
    static constexpr int OBJECT_COLLISION_ESTIMATOR_CALLBACK = 45;
    static constexpr int BEHAVIOR_PLANNER_CALLBACK_1 = 46;
    static constexpr int BEHAVIOR_PLANNER_CALLBACK_2 = 36;
    static constexpr int BEHAVIOR_PLANNER_CALLBACK_3 = 27;
    static constexpr int BEHAVIOR_PLANNER_CALLBACK_4 = 29;
    static constexpr int BEHAVIOR_PLANNER_CALLBACK_5 = 28;
    static constexpr int BEHAVIOR_PLANNER_CALLBACK_6 = 30;
    static constexpr int BEHAVIOR_PLANNER_CALLBACK_7 = 47;
    static constexpr int MPC_CONTROLLER_CALLBACK = 48;
    static constexpr int VEHICLE_INTERFACE_CALLBACK_1 = 50;
    static constexpr int VEHICLE_INTERFACE_CALLBACK_2 = 49;
    static constexpr int VEHICLE_DBW_SYSTEM_CALLBACK = 51;
  };
